...
var render_mermaid_1 = require("./render-mermaid");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(instances.map(function (_a) {
                                var node = _a[0], index = _a[1], parent = _a[2];
                                return __awaiter(_this, void 0, void 0, function () {
                                    var html;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0: return [4 /*yield*/, (0, render_mermaid_1.default)({
                                                    config: {},
                                                    code: node.value,
                                                }).then(function (diagram) { return diagram; })];
                                            case 1:
                                                html = _b.sent();
                                                parent.children.splice(index, 1, {
                                                    type: 'html',
                                                    value: "<div class=\"mermaid-diagram\" style=\"".concat(style, "\">").concat(html, "</div>"),
